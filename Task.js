...
// List all the products with above average price
const {price} = products;
const sum = products.reduce((p,c) => p+c.price,0)
const avg = sum/products.length;
const aboveAvg = products.filter((n) => n.price>avg)
...
const distincCategory = new Set(allCategory);
console.log(distincCategory);

// (4) Print Average price and rating of the products
// price is already destructure
const total = products.reduce((p,c) => p+c.price,0)
const averagePrice = total/products.length;
console.log(averagePrice)

// rating is already destructure
const ratings = products.map((n) => n.rating.rate)
console.log(ratings)

//list top 5 products with highest rating and lowest price
const sortRating = products.sort((a,b) => b.rating.rate-a.rating.rate)
const sortPriceAndRate = sortRating.sort((a,b) => a.price-b.price)
for(let i=0; i<5; i++) {
    console.log(sortPriceAndRate[i])
}